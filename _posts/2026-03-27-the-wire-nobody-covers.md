...
<div style="font-size: 20px; font-weight: 700; color: #fff; margin-bottom: 16px;">Loss: $400,000</div>
...
<div style="margin-top: auto; padding-top: 10px; border-top: 1px solid rgba(255,255,255,0.12);"><div style="font-size: 20px; font-weight: 700; color: #FCD34D;">$200,000</div></div>
</div>
...
If your bank has not had someone review how your cyber policy, fidelity bond, and D&O interact on wire fraud, a [Risk Intelligence Report]({{ '/risk-intelligence-report/' | relative_url }}) will show you exactly where you stand. [Get in touch]({{ '/contact/' | relative_url }}).
