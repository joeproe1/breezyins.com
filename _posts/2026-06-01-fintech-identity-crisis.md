...
<p style="margin-top: 20px; margin-bottom: 0; font-size: 15px; color: rgba(255,255,255,0.55); line-height: 1.5;">Each requirement is satisfied independently. Different brokers, different carriers, different renewal dates. The program is assembled by accident, not by design.</p>
</div>
...
<div><strong>How many policies are in your program, and has anyone read them together?</strong> If the answer is "I'm not sure," nobody is coordinating them.</div>
</div>
<div style="display: flex; gap: 16px; margin-bottom: 20px;">
...
<div><strong>Do you have Crime or Fidelity coverage separate from your cyber policy?</strong> If not, check whether your cyber policy covers stolen funds or only data breach costs.</div>
</div>
<div style="display: flex; gap: 16px; margin-bottom: 20px;">
...
<div><strong>Does your bank partner contract require coverage types you haven't verified against the actual policy?</strong> Certificates confirm a policy exists. They don't confirm it covers what the contract requires.</div>
</div>
...
<div><strong>When was your D&O last reviewed against current operations?</strong> If the answer is "at Series A," the policy might reflect a company that no longer exists.</div>
</div>
</div>
