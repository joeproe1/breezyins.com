...
Most coverage gaps are not inside a single policy. They live in the seams between two or three policies that were written by different carriers, at different times, for different risks. Nobody tested whether they work together. The interaction map does that test.

You can see a [sample interaction map]({{ '/community-bank-insurance/' | relative_url }}) on the community bank insurance page.

## Who Uses the Report

The report is designed for three audiences. Each one uses it differently.
...
There is no broker of record letter. No commitment to move your insurance. Most banks take the findings to their current broker and use them to negotiate better terms at renewal. Some share the report with their board or examiner. What you do with it is up to you.
...
Each finding comes with specific policy language, a dollar-range exposure estimate, and a recommended fix the broker can implement at renewal.
