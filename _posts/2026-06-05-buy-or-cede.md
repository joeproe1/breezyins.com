...
<div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 16px; margin: 28px 0;" class="stat-grid-boc">
<style>.stat-grid-boc { grid-template-columns: repeat(3, 1fr) !important; } @media (max-width: 600px) { .stat-grid-boc { grid-template-columns: 1fr !important; } }</style>
<div style="background: rgba(0, 212, 170, 0.08); border-radius: 10px; padding: 24px 20px; text-align: center;">
<div style="font-size: 36px; font-weight: 700; color: #00D4AA; line-height: 1.2;">$10.9B</div>
<div style="font-size: 14px; color: #6B7B8D; margin-top: 8px; line-height: 1.4;">Zurich's acquisition<br>price for Beazley</div>
</div>
<div style="background: rgba(0, 212, 170, 0.08); border-radius: 10px; padding: 24px 20px; text-align: center;">
<div style="font-size: 36px; font-weight: 700; color: #00D4AA; line-height: 1.2;">$1.3B</div>
<div style="font-size: 14px; color: #6B7B8D; margin-top: 8px; line-height: 1.4;">Beazley's cyber<br>premium book</div>
</div>
<div style="background: rgba(0, 212, 170, 0.08); border-radius: 10px; padding: 24px 20px; text-align: center;">
<div style="font-size: 36px; font-weight: 700; color: #00D4AA; line-height: 1.2;">74.8%</div>
<div style="font-size: 14px; color: #6B7B8D; margin-top: 8px; line-height: 1.4;">Combined operating<br>ratio in 2024</div>
</div>
</div>
...
<div style="font-size: 20px; font-weight: 600; line-height: 1.5; color: #0A2540;">Allianz keeps the balance sheet exposure. Coalition runs the engine.</div>
</div>
...
*If your insurance program includes carriers or MGAs affected by this consolidation, an independent audit can tell you what changed and whether it matters. [Get in touch]({{ '/contact/' | relative_url }}).*
