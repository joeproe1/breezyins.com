...
<div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 16px; margin: 28px 0;" class="stat-grid-hvh">
<style>.stat-grid-hvh { grid-template-columns: repeat(3, 1fr) !important; } @media (max-width: 600px) { .stat-grid-hvh { grid-template-columns: 1fr !important; } }</style>
<div style="background: rgba(0, 212, 170, 0.08); border-radius: 10px; padding: 24px 20px; text-align: center;">
<div style="font-size: 36px; font-weight: 700; color: #00D4AA; line-height: 1.2;">$1.2B+</div>
<div style="font-size: 14px; color: #6B7B8D; margin-top: 8px; line-height: 1.4;">Outstanding cyber<br>cat bonds</div>
</div>
<div style="background: rgba(0, 212, 170, 0.08); border-radius: 10px; padding: 24px 20px; text-align: center;">
<div style="font-size: 36px; font-weight: 700; color: #00D4AA; line-height: 1.2;">36%</div>
<div style="font-size: 14px; color: #6B7B8D; margin-top: 8px; line-height: 1.4;">Risk premium<br>decline, 2024 to 2025</div>
</div>
<div style="background: rgba(0, 212, 170, 0.08); border-radius: 10px; padding: 24px 20px; text-align: center;">
<div style="font-size: 36px; font-weight: 700; color: #00D4AA; line-height: 1.2;">0</div>
<div style="font-size: 14px; color: #6B7B8D; margin-top: 8px; line-height: 1.4;">Cyber cat bonds<br>ever triggered</div>
</div>
</div>
...
<div style="font-size: 20px; font-weight: 600; line-height: 1.5; color: #0A2540;">Zurich did not just buy cyber underwriting. They bought the ability to move cyber risk off a carrier balance sheet and into capital markets at a scale nobody else has matched.</div>
</div>
...
<div style="border-left: 4px solid #00D4AA; padding: 24px 28px; background: rgba(0, 212, 170, 0.06); border-radius: 0 8px 8px 0; margin: 40px 0;">
<div style="font-size: 20px; font-weight: 600; line-height: 1.5; color: #0A2540;">Hurricanes have the courtesy of hitting one coastline at a time.<br>A cyber attack does not.</div>
</div>
