...
<div style="color: rgba(255,255,255,0.8); font-size: 15px; line-height: 1.55;">Not applicable for this scenario. No theft, no fraud, no employee dishonesty.</div>
...
<div><strong>Check whether your D&O cyber exclusion captures vendor-caused events.</strong> The phrase "arising out of or in any way involving" is broad enough to include incidents that originated outside the bank entirely. Ask your broker whether the exclusion distinguishes between a breach at the bank and a breach at a vendor.</div>
</div>
...
<div><strong>Review the vendor risk management documentation your board receives.</strong> If an examiner asks whether the board oversaw fourth-party risk, the answer needs to be in the minutes: committee assignments, management reports on vendor concentrations, and escalation records.</div>
</div>
</div>
