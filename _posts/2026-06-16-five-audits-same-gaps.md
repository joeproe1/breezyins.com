...
This is how fidelity bonds are designed. Multiple fraud coverages with non-overlapping definitions and different limits. But nobody maps the Classification Swing for the bank before a claim happens. The bank only sees its headline limit and assumes that's what it will recover.
